function GenesysChatUI($, ndContainer, oTransport, oTransportData){
    ...
    this.checkForm = function(){
        ...
        oTransportData.formData["firstname"] = "Voice Apps";
        oTransportData.formData["lastname"] = "User";
        oTransportData.formData["nickname"] = "user";
        oTransportData.formData["subject"] = "My iPhone 6 has a broken screen";
        oTransportData.formData["email"] = "david.beilis@genesys.com";
